...
def train(cfg: DictConfig) -> Optional[float]:
    ...
    if (actual_batch_size := getattr(cfg, "actual_batch_size", None)) is not None:
        batch_size = cfg.datamodule.dataloader_cfg.train.batch_size
        cfg.trainer.accumulate_grad_batches = batch_size // actual_batch_size
        cfg.datamodule.dataloader_cfg.train.batch_size = actual_batch_size
        log.info(f"Set batch size to {actual_batch_size} and accumulating for {batch_size // actual_batch_size}")
